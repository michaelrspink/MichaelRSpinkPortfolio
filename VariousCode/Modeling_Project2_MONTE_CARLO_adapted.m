...
%% on the effects of the amounts of hunters  %%
%% and pigs in a given area                  %%
%%                                           %%
%%  param- milage- how big of area           %%
%%  param- radius- radius for hunters        %%
%%         to patrol. They kill pigs         %%
%%             in their radius               %%
%%  param- pigcounter- number of pigs        %%
%%  param- huntercount- number of hunters    %%
%%  param- trigger                           %%
%%    0 = just 3 graphs                      %%
%%    1 = all prev graphs in session kept    %%
%%        + effects of trigger=0             %%
...
function pigcountcurr =MM_P2_MONTE_CARLO(milage,radius,pigcount,huntercount, trigger) %% This function can be called with values TBD
...
xlength=milage; %% CHANGE HERE FOR DIFFERENT RESULTS
ylength=milage; %% CHANGE HERE FOR DIFFERENT RESULTS
if(trigger==0)
